...
public class CommonVariables {
	...
	public static ThreadLocal<MobileLibrary> objMobileFunc = new ThreadLocal<MobileLibrary>();
	...
	/* Added to handle mobile testing
	 * 
	 */
	public static ThreadLocal<String> UDID = new ThreadLocal<String>();
	public static ThreadLocal<String> platformVersion = new ThreadLocal<String>();
	public static ThreadLocal<String> browserName = new ThreadLocal<String>();
	public static ThreadLocal<String> serverURL = new ThreadLocal<String>();
	 ...
	 * <b>Description:</b> This is setter for ActionObject.
	 */
	public static void setMobileActionLib(){
		if(getMobileActionLib()==null)
			objMobileFunc.set(new MobileLibrary(CommonDriver.get()));
	}
	...
	/**
	 * <b>Description:</b> This is getter for MobileObject.
	 * @return Instance of ActionLib
	 */
	public static MobileLibrary getMobileActionLib(){
		return objMobileFunc.get();
	}
