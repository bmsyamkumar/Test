...
public class QuoteAccept extends TestEngineWeb {
    ...
    Sheet DataSheet = file.readExcel(System.getProperty("user.dir").replace("\\", "/") + "/testdata","WisrAutomationTestData.xlsx" , "QuoteAcceptResult");
